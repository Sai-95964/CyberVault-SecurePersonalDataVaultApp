...
class _VaultHomeScreenState extends State<VaultHomeScreen>
  ...
  static const _localUserId = 'current_user'; // fallback for local backend
  ...
  Future<void> _loadDocuments() async {
    ...
    try {
      final userId = FirestoreService.useLocalBackend
          ? _localUserId
          : (await _currentUserId()) ?? _localUserId;
      final docs = await DocumentsRepository.instance.loadMetadata(userId);
      if (mounted) {
        setState(() {
          _documents = docs;
          _applyFilter();
  ...
  Future<String?> _currentUserId() async {
    return FirestoreService.useLocalBackend
        ? _localUserId
        : FirebaseAuthService.instance.currentUserId;
  }
  ...
  Future<void> _deleteDocument(DocumentMetadata meta) async {
    ...
    try {
      final userId = FirestoreService.useLocalBackend
          ? _localUserId
          : (await _currentUserId()) ?? _localUserId;
      await FirestoreService.instance.deleteDocument(userId, meta.id);
